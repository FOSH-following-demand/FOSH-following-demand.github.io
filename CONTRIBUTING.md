...
`FOSH-following-demand` is a young project maintained by a growing group of enthusiastic developers&mdash; and we're excited to have you join!
...
As a reminder, we expect all contributions to `FOSH-following-demand` to adhere to our [code of conduct][link_coc].
...
* **Milestones** are the link between the issues and the high level strategy for the ``FOSH-following-demand`` project.
Contributors new and old are encouraged to take a look at the milestones to see how we are progressing
towards ``FOSH-following-demand``'s shared vision.
...
The ``FOSH-following-demand``  maintainers use this board to keep an eye on how tasks are progressing week by week.
...
**2. [Fork][link_fork] the [FOSH-following-demand repository][link_FOSH-following-demand] to your profile.**
...
When you're creating your pull request, please make sure to review the FOSH-following-demand [style conventions](#style-guide).
...
[link_FOSH-following-demand]: https://github.com/FOSH-following-demand/FOSH-following-demand.github.io
...
[link_issues]: https://github.com/FOSH-following-demand/FOSH-following-demand.github.io/issues
[link_milestones]: https://github.com/FOSH-following-demand/FOSH-following-demand.github.io/milestones/
[link_project_boards]: https://github.com/FOSH-following-demand/FOSH-following-demand.github.io/projects
[link_gitter]: https://gitter.im/FOSH-following-demand/FOSH-following-demand.github.io
[link_coc]: https://github.com/FOSH-following-demand/FOSH-following-demand.github.io/blob/master/Code_of_Conduct.md

[link_labels]: https://github.com/FOSH-following-demand/FOSH-following-demand.github.io/labels
...
[link_contributors]: https://github.com/FOSH-following-demand/FOSH-following-demand.github.io/graphs/contributors
